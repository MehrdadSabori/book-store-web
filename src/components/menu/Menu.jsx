...
function Menu({ toggleMenu, showMenu }) {
    const [menuNav, setMenuNav] = useState('')
    const contextData = useContext(ContextDatas);
    if (showMenu) {
        setTimeout(() => {
            setMenuNav('menu_navbar_active')
        }, 0)
    } else if (!showMenu) {
        setTimeout(() => {
            setMenuNav('')
    ...
    return (
        <>
            <div className={`header_contaner menu_navbar_contaner ${menuNav}`}>
                <div className="logo_and_close_button">
                    <button className='btn btn_close_menu' onClick={toggleMenu}>
                        <AiOutlineCloseCircle />
                    </button>
                    <div className="logo_section logo_menu_navbar">
                        <svg
                ...
                <SearchBox className={'search_menu_navbar'} />
                <menu>
                    <div className="menu_items_section menu_navbar_items">
                        <ul>
                            <li>
                ...
                <hr className='hr_menu_nevbar' />
                <span className='Theme_text'>
                    {contextData.darkMode ? `زمینه تیره` : `زمینه روشن`}
                </span>
                <div className="icon_section_togglemode_border">
